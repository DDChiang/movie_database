...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { approved: @director.approved, birthday: @director.birthday, first: @director.first, last: @director.last, slug: @director.slug }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { approved: @director.approved, birthday: @director.birthday, first: @director.first, last: @director.last, slug: @director.slug }
    assert_redirected_to director_path(assigns(:director))
  end
