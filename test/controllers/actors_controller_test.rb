...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { approved: @actor.approved, birthday: @actor.birthday, first: @actor.first, last: @actor.last, slug: @actor.slug }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { approved: @actor.approved, birthday: @actor.birthday, first: @actor.first, last: @actor.last, slug: @actor.slug }
    assert_redirected_to actor_path(assigns(:actor))
  end
